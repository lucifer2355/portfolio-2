...
const About = () => {
  return (
    <>
      <Head>
        <title>About | Dhruvil Gajjar</title>
          ...
          <div className='flex flex-col xl:flex-row xl:h-screen xl:pt-5 xl:-mb-36'>
            ...
            <div className='flex flex-col xl:w-3/6 xl:pl-10 xl:mt-9'>
              ...
              <p className='text-gray-400 text-justify font-mono mt-2 xl:text-lg'>
                I’m a Web & Mobile App developer, from India. Middle of my
                college degree in "Information & Technology", I got a job as a
                "SOFTWARE DEVELOPER", where I stayed for almost 2.4 years, and I
                developed websites with Magento, mobile applications with
                React-Native.
              </p>
